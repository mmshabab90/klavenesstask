...
const patchUrl = "http://localhost:1337/contract/";
...
function ContractForm({ show, handleClose }) {
  ...
  const handleDelete = () => {
    console.log(selectedItem.contractId);
    console.log(typeof parseInt(selectedItem.contractId));
  };
        ...
        <Formik
          ...
          onSubmit={async (values, { setSubmitting }) => {
            if (selectedItem) {
              ...
              await axios
                .patch(
                  `${patchUrl}${parseInt(selectedItem.contractId)}`,
